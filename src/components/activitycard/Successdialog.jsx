      ...
      <div className="relative w-343 h-488 bg-black-medium rounded-lg my-6 flex flex-col items-center px-10 pt-55 lg:justify-center">
        ...
        <div className="z-50">
          <button
            ...
            className="secondary-contained-button clickbutton flex justify-center items-center w-[263px] h-[48px] p-3 rounded text-black-dark font-roboto-mono font-bold"
          >
            Continue
          </button>
        </div>
